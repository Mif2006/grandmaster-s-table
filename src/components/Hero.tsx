...
import heroBackground from "@/assets/futuristic-chess-5.jpg";
...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      <motion.div
        className="absolute left-8 md:left-16 top-1/2 -translate-y-1/2 z-10 flex flex-col items-center gap-1 md:gap-2"
